	...
	protected function criar_menus_en( $termos_en ) {
		...
		$this->montar_menu_traduzido(
			...
			array(
				...
				// array( 'titulo' => 'Case studies', 'url' => $cases_url ), // oculto
	...
	protected function texto_en_solucao_salesforce() {
		return $this->solucao_en(
			array(
				...
				'solucao_pilares_titulo'       => "Integrations that are faster,\nsafer and smarter",
				...
				'solucao_casos_titulo'         => "Integrations that are faster,\nsafer and smarter",
	...
	protected function texto_en_solucao_rd_station_crm() {
		return $this->solucao_en(
			array(
				...
				'solucao_pilares_1_desc'   => 'Turn won deals in RD Station CRM into ERP orders without manual re-entry or manual processes.',
				'solucao_pilares_2_titulo' => 'Enrich leads automatically',
				'solucao_pilares_2_desc'   => 'Complete commercial information using data from other systems and offer a more personalised approach.',
				'solucao_pilares_3_titulo' => 'Connect systems as you grow',
				'solucao_pilares_3_desc'   => 'Structure integrations between CRM, ERP and digital applications as your commercial operation grows.',
				'solucao_casos_titulo'     => 'Automate the processes of the sales cycle',
				'solucao_casos_1_titulo'   => 'Send won deals to the ERP',
				'solucao_casos_1_desc'     => 'Sync won opportunities from RD Station CRM directly to order creation in the ERP.',
				'solucao_casos_2_titulo'   => 'Enrich lead data',
				'solucao_casos_2_desc'     => 'Combine product, support and other system data to generate better commercial opportunities.',
				'solucao_casos_3_titulo'   => 'Connect purchase history',
				'solucao_casos_3_desc'     => 'Integrate e-commerce platforms with the CRM to get a full view of every customer relationship.',
				'solucao_casos_4_titulo'   => 'Consolidate data for BI',
				'solucao_casos_4_desc'     => 'Centralise commercial funnel data in analytics platforms for faster decision-making.',
				'solucao_casos_5_titulo'   => 'Distribute leads automatically',
				'solucao_casos_5_desc'     => 'Route opportunities between commercial teams according to rules defined by your operation.',
				'solucao_dif_titulo'       => 'Secure integrations on the official API',
				'solucao_dif_corpo'        => 'Connect RD Station CRM using official APIs, individual tokens per account and controlled permissions to ensure security and governance.',
				...
				'solucao_plat_corpo'       => 'Growing companies connect RD Station, local ERPs and new systems without a professional integration layer. Centralise processes to reduce rework and scale with confidence.',
				...
				'solucao_acel_corpo'       => 'Use a structured template to sync won deals from RD Station CRM with the ERP and accelerate the delivery of commercial value.',
