	...
	protected function texto_es_solucao_rd_station_crm() {
		return $this->solucao_es(
			array(
				...
				'solucao_pilares_1_desc'   => 'Transforme los negocios cerrados en RD Station CRM en pedidos en el ERP sin redigitación ni procesos manuales.',
				'solucao_pilares_2_titulo' => 'Enriquezca leads automáticamente',
				'solucao_pilares_2_desc'   => 'Complete la información comercial usando datos de otros sistemas y ofrezca un enfoque más personalizado.',
				'solucao_pilares_3_titulo' => 'Conecte sistemas en crecimiento',
				'solucao_pilares_3_desc'   => 'Estructure las integraciones entre CRM, ERP y aplicaciones digitales conforme evoluciona su operación comercial.',
				'solucao_casos_titulo'     => 'Automatice procesos del ciclo comercial',
				'solucao_casos_1_titulo'   => 'Envíe negocios ganados al ERP',
				'solucao_casos_1_desc'     => 'Sincronice las oportunidades cerradas de RD Station CRM directamente para la creación de pedidos en el ERP.',
				'solucao_casos_2_titulo'   => 'Enriquezca los datos de leads',
				'solucao_casos_2_desc'     => 'Combine información de producto, soporte y otros sistemas para generar mejores oportunidades comerciales.',
				'solucao_casos_3_titulo'   => 'Conecte el historial de compras',
				'solucao_casos_3_desc'     => 'Integre plataformas de e-commerce al CRM para visualizar toda la relación con el cliente.',
				'solucao_casos_4_titulo'   => 'Consolide datos para BI',
				'solucao_casos_4_desc'     => 'Centralice la información del embudo comercial en plataformas analíticas para decisiones más rápidas.',
				'solucao_casos_5_titulo'   => 'Distribuya leads automáticamente',
				'solucao_casos_5_desc'     => 'Dirija oportunidades entre equipos comerciales según las reglas definidas por la operación.',
				'solucao_dif_titulo'       => 'Integraciones seguras con API oficial',
				'solucao_dif_corpo'        => 'Conecte RD Station CRM mediante APIs oficiales, tokens individuales por cuenta y permisos controlados para garantizar seguridad y gobernanza.',
				...
				'solucao_plat_corpo'       => 'Las empresas en crecimiento conectan RD Station, ERPs locales y nuevos sistemas sin una capa profesional de integración. Centralice los procesos para reducir el retrabajo y evolucionar con seguridad.',
				...
				'solucao_acel_corpo'       => 'Utilice un modelo estructurado para sincronizar los negocios cerrados de RD Station CRM con el ERP y acelere la entrega de valor comercial.',
