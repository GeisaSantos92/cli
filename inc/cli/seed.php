...
class Cliconnect_Seed {
	...
	public function __invoke( $args, $assoc_args ) {
		...
		WP_CLI::log( '— Preenchendo Thomson Reuters Tax One…' );
		$this->preencher_solucao_thomson_reuters_tax_one();

		WP_CLI::log( '— Preenchendo Freshservice…' );
		$this->preencher_solucao_freshservice();

		WP_CLI::log( '— Preenchendo ServiceNow…' );
		$this->preencher_solucao_servicenow();

		WP_CLI::log( '— Preenchendo Portal de API / MCP Server…' );
		$this->preencher_solucao_portal_de_api();

		WP_CLI::log( '— Preenchendo Zendesk…' );
		$this->preencher_solucao_zendesk();

		WP_CLI::log( '— Preenchendo Bionexo…' );
		$this->preencher_solucao_bionexo();

		WP_CLI::log( '— Preenchendo Tasy…' );
		$this->preencher_solucao_tasy();

		WP_CLI::log( '— Preenchendo MV…' );
