...
[submit "Enviar"]';
	...
	protected function preencher_solucao_rd_station() {
		...
		$campos  = array(
			...
			'solucao_pilares_1_desc'   => 'Transforme negócios fechados no RD Station CRM em pedidos no ERP sem redigitação ou processos manuais.',
			'solucao_pilares_2_icone'  => $this->img( 'rd-station-pilar-2' ),
			'solucao_pilares_2_titulo' => 'Enriqueça leads automaticamente',
			'solucao_pilares_2_desc'   => 'Complete informações comerciais usando dados de outros sistemas e ofereça uma abordagem mais personalizada.',
			'solucao_pilares_3_icone'  => $this->img( 'rd-station-pilar-3' ),
			'solucao_pilares_3_titulo' => 'Conecte sistemas em crescimento',
			'solucao_pilares_3_desc'   => 'Estruture integrações entre CRM, ERP e aplicações digitais conforme sua operação comercial evolui.',
			...
			'solucao_casos_1_desc'    => 'Sincronize oportunidades fechadas do RD Station CRM diretamente para criação de pedidos no ERP.',
			'solucao_casos_2_icone'   => $this->img( 'rd-station-caso-2' ),
			'solucao_casos_2_titulo'  => 'Enriqueça dados de leads',
			'solucao_casos_2_desc'    => 'Combine informações de produto, suporte e outros sistemas para gerar melhores oportunidades comerciais.',
			'solucao_casos_3_icone'   => $this->img( 'rd-station-caso-3' ),
			'solucao_casos_3_titulo'  => 'Conecte histórico de compras',
			'solucao_casos_3_desc'    => 'Integre plataformas de e-commerce ao CRM para visualizar todo relacionamento com o cliente.',
			'solucao_casos_4_icone'   => $this->img( 'rd-station-caso-4' ),
			'solucao_casos_4_titulo'  => 'Consolide dados para BI',
			'solucao_casos_4_desc'    => 'Centralize informações do funil comercial em plataformas analíticas para decisões mais rápidas.',
			'solucao_casos_5_icone'   => $this->img( 'rd-station-caso-5' ),
			'solucao_casos_5_titulo'  => 'Distribua leads automaticamente',
			'solucao_casos_5_desc'    => 'Direcione oportunidades entre equipes comerciais conforme regras definidas pela operação.',
			'solucao_casos_cta_texto' => 'Agende uma demonstração',
			'solucao_casos_cta_url'   => '/contato/',
			...
			'solucao_dif_corpo'       => 'Conecte o RD Station CRM utilizando APIs oficiais, tokens individuais por conta e permissões controladas para garantir segurança e governança.',
			...
			'solucao_plat_corpo'      => 'Empresas em crescimento conectam RD Station, ERPs locais e novos sistemas sem uma camada profissional de integração. Centralize processos para reduzir retrabalho e evoluir com segurança.',
			...
			'solucao_acel_corpo'      => 'Utilize um modelo estruturado para sincronizar negócios fechados do RD Station CRM com o ERP e acelere a entrega de valor comercial.',
	...
	protected function preencher_solucao_oracle_netsuite() {
		...
		$campos  = array(
			...
			'solucao_hero_corpo'      => 'Integre NetSuite ao e-commerce, CRM e sistemas financeiros para escalar operações globais sem criar customizações específicas para cada integração.',
			'solucao_hero_btn1_texto' => 'Agende uma demonstração',
			'solucao_hero_btn1_url'   => '/contato/',
			'solucao_hero_btn2_texto' => 'Conheça nossa solução',
			...
			'solucao_dif_corpo'    => 'Conecte o NetSuite usando autenticação Token-Based Authentication e OAuth 2.0 para proteger acessos corporativos.',
			...
			'solucao_plat_corpo'    => 'Centralize integrações do NetSuite OneWorld para replicar processos em novas subsidiárias sem reconstruir customizações.',
			...
			'solucao_acel_corpo'     => 'Utilize um modelo pronto para conectar NetSuite OneWorld ao e-commerce e CRM em operações multi-subsidiária.',
			'solucao_acel_topico_1'  => 'Conecte operações rapidamente',
			'solucao_acel_topico_2'  => 'Reutilize fluxos globais',
			'solucao_acel_topico_3'  => 'Acelere novas unidades',
			'solucao_acel_topico_4'  => 'E muito mais...',
			'solucao_acel_btn_texto' => 'Começar agora',
			'solucao_acel_btn_url'   => '/contato/',
	...
	protected function preencher_solucao_snowflake() {
		...
		$campos  = array(
			...
			'solucao_hero_titulo'     => 'Alimente o Snowflake com dados operacionais em tempo real',
			'solucao_hero_corpo'      => 'Conecte ERP, CRM e e-commerce ao Snowflake para eliminar dependência de cargas noturnas e acelerar decisões com dados atualizados.',
			'solucao_hero_btn1_texto' => 'Agende uma demonstração',
			'solucao_hero_btn1_url'   => '/contato/',
			'solucao_hero_btn2_texto' => 'Conheça nossa solução',
			...
			// 2 · Pilares.
			'solucao_pilares_titulo'   => 'Transforme dados em decisões rápidas',
			'solucao_pilares_1_icone'  => $this->img( 'snowflake-pilar-1' ),
			'solucao_pilares_1_titulo' => 'Ingestione dados em tempo real',
			'solucao_pilares_1_desc'   => 'Conecte sistemas operacionais ao Snowflake continuamente.',
			'solucao_pilares_2_icone'  => $this->img( 'snowflake-pilar-2' ),
			'solucao_pilares_2_titulo' => 'Supere limites do batch',
			'solucao_pilares_2_desc'   => 'Reduza dependência de cargas noturnas para dados críticos.',
			'solucao_pilares_3_icone'  => $this->img( 'snowflake-pilar-3' ),
			'solucao_pilares_3_titulo' => 'Unifique múltiplas fontes',
			'solucao_pilares_3_desc'   => 'Consolide ERP, CRM e e-commerce em um único ambiente.',

			// 3 · Casos de uso.
			'solucao_casos_eyebrow'   => 'casos de uso',
			'solucao_casos_titulo'    => 'Automatize fluxos de dados com Snowflake',
			'solucao_casos_1_icone'   => $this->img( 'snowflake-caso-1' ),
			'solucao_casos_1_titulo'  => 'Envie transações ao Snowflake',
			'solucao_casos_1_desc'    => 'Ingestione pedidos e dados comerciais em tempo real.',
			'solucao_casos_2_icone'   => $this->img( 'snowflake-caso-2' ),
			'solucao_casos_2_titulo'  => 'Consolide sistemas corporativos',
			'solucao_casos_2_desc'    => 'Una SAP, Salesforce e e-commerce em um único data warehouse.',
			'solucao_casos_3_icone'   => $this->img( 'snowflake-caso-3' ),
			'solucao_casos_3_titulo'  => 'Alimente IA e BI',
			'solucao_casos_3_desc'    => 'Disponibilize dados atualizados para modelos analíticos.',
			'solucao_casos_4_icone'   => $this->img( 'snowflake-caso-4' ),
			'solucao_casos_4_titulo'  => 'Execute reverse ETL',
			'solucao_casos_4_desc'    => 'Retorne insights do Snowflake aos sistemas operacionais.',
			...
			// 5 · Diferencial Técnico.
			'solucao_dif_eyebrow'  => 'diferencial técnico',
			'solucao_dif_titulo'   => 'Integrações seguras para dados corporativos',
			'solucao_dif_corpo'    => 'Conecte o Snowflake com autenticação key-pair ou OAuth mantendo governança de dados e proteção de informações sensíveis.',
			'solucao_dif_topico_1' => 'Utilize autenticação segura',
			'solucao_dif_topico_2' => 'Proteja dados sensíveis',
			'solucao_dif_topico_3' => 'Aplique controles de governança',
			'solucao_dif_imagem'   => $this->img( 'snowflake-dif' ),

			// 6 · Plataforma Única.
			'solucao_plat_eyebrow'  => 'plataforma única',
			'solucao_plat_titulo'   => 'Conecte toda sua arquitetura de dados',
			'solucao_plat_corpo'    => 'Centralize integrações entre sistemas operacionais e Snowflake sem criar pipelines isolados para cada fonte de informação.',
			'solucao_plat_topico_1' => 'Integre múltiplas fontes',
			'solucao_plat_topico_2' => 'Reutilize pipelines existentes',
			'solucao_plat_topico_3' => 'Simplifique arquitetura de dados',
			'solucao_plat_imagem'   => $this->img( 'snowflake-plat' ),

			// 7 · Aceleradores.
			'solucao_acel_eyebrow'   => 'Aceleradores de integração',
			'solucao_acel_titulo'    => 'Comece com dados conectados',
			'solucao_acel_corpo'     => 'Utilize um modelo pronto para levar dados de ERP, CRM e e-commerce ao Snowflake em tempo real.',
			'solucao_acel_topico_1'  => 'Conecte fontes rapidamente',
			'solucao_acel_topico_2'  => 'Reduza projetos manuais',
			'solucao_acel_topico_3'  => 'Acelere análises corporativas',
			'solucao_acel_topico_4'  => 'E muito mais...',
			'solucao_acel_btn_texto' => 'Começar agora',
			'solucao_acel_btn_url'   => '/contato/',
	...
	protected function criar_faq_snowflake( $post_id ) {
		$itens = array(
			array(
				'faq:snowflake-etl-batch',
				'Como reduzir a dependência de ETL batch noturno para o Snowflake?',
				'<p>A CLI Connect, via Boomi, permite substituir cargas noturnas por fluxos de integração contínuos ou baseados em eventos. Em vez de aguardar o processamento em lote, os dados são transferidos ao Snowflake conforme são gerados nos sistemas operacionais — pedidos, transações, atualizações de estoque — garantindo que dashboards e modelos analíticos reflitam o estado real do negócio em tempo próximo ao real.</p>',
			),
			array(
				'faq:snowflake-reverse-etl',
				'É possível fazer reverse ETL (Snowflake → sistemas operacionais)?',
				'<p>Sim. A integração bidirecional permite que insights gerados no Snowflake — como scores de clientes, previsões de demanda ou alertas de estoque — sejam enviados de volta ao CRM, ERP ou outras plataformas operacionais. Os fluxos são configurados visualmente na Boomi, com suporte a transformações e mapeamento de esquemas para garantir compatibilidade entre os sistemas.</p>',
			),
			array(
				'faq:snowflake-pii',
				'Como funciona a governança de PII nos dados ingeridos?',
				'<p>A CLI Connect aplica controles de governança em todo o pipeline: os dados trafegam criptografados em trânsito e em repouso, e é possível configurar mascaramento ou anonimização de campos sensíveis antes de carregá-los no Snowflake. Os fluxos registram logs de auditoria rastreáveis, facilitando a demonstração de conformidade com LGPD e GDPR durante auditorias.</p>',
			),
		);
	...
	protected function preencher_solucao_gemini() {
		...
		$campos = array(
			...
			'solucao_casos_1_desc'    => 'Permita consultas em linguagem natural sobre pedidos, estoque, clientes e outros dados operacionais.',
			'solucao_casos_2_icone'   => $this->img( 'gemini-caso-2' ),
			'solucao_casos_2_titulo'  => 'Analise documentos automaticamente',
			'solucao_casos_2_desc'    => 'Interprete contratos, relatórios, propostas e outros documentos para acelerar análises e processos.',
			'solucao_casos_3_icone'   => $this->img( 'gemini-caso-3' ),
			'solucao_casos_3_titulo'  => 'Automatize o atendimento',
			'solucao_casos_3_desc'    => 'Combine histórico do cliente, pedidos e informações de suporte para gerar respostas mais completas.',
			'solucao_casos_4_icone'   => $this->img( 'gemini-caso-4' ),
			'solucao_casos_4_titulo'  => 'Classifique solicitações',
			'solucao_casos_4_desc'    => 'Interprete mensagens e documentos para identificar demandas e direcioná-las automaticamente ao processo adequado.',
			'solucao_casos_5_icone'   => $this->img( 'gemini-caso-5' ),
			'solucao_casos_5_titulo'  => 'Gere análises operacionais',
			'solucao_casos_5_desc'    => 'Combine dados de diferentes sistemas para resumir cenários e apoiar decisões com informações atualizadas.',
			'solucao_casos_cta_texto' => 'Agende uma demonstração',
			'solucao_casos_cta_url'   => '/contato/',
	...
	protected function preencher_solucao_claude() {
		...
		$campos = array(
			...
			'solucao_casos_1_desc'     => 'Analise contratos e destaque cláusulas, obrigações, riscos e pontos que exigem atenção antes da aprovação.',
			'solucao_casos_2_icone'    => $this->img( 'claude-caso-2' ),
			'solucao_casos_2_titulo'   => 'Consulte políticas internas',
			'solucao_casos_2_desc'     => 'Permita que equipes encontrem respostas em políticas, procedimentos e documentos corporativos sem procurar manualmente.',
			'solucao_casos_3_icone'    => $this->img( 'claude-caso-3' ),
			'solucao_casos_3_titulo'   => 'Analise solicitações de clientes',
			'solucao_casos_3_desc'     => 'Interprete mensagens e históricos para identificar a demanda, reunir contexto e orientar o próximo passo.',
			'solucao_casos_4_icone'    => $this->img( 'claude-caso-4' ),
			'solucao_casos_4_titulo'   => 'Compare propostas comerciais',
			'solucao_casos_4_desc'     => 'Extraia e compare condições, preços, prazos e requisitos de diferentes propostas para acelerar avaliações.',
			'solucao_casos_5_icone'    => $this->img( 'claude-caso-5' ),
			'solucao_casos_5_titulo'   => 'Resuma históricos operacionais',
			'solucao_casos_5_desc'     => 'Consolide registros de atendimento, pedidos e interações para entregar uma visão rápida de cada situação.',
			'solucao_casos_cta_texto'  => 'Agende uma demonstração',
			'solucao_casos_cta_url'    => '/contato/',
	...
	protected function preencher_solucao_chatgpt() {
		...
		$campos = array(
			...
			'solucao_casos_1_titulo'   => 'Consulte dados do ERP com IA',
			'solucao_casos_1_desc'     => 'Permita que usuários consultem informações de pedidos, estoque e clientes usando linguagem natural.',
			'solucao_casos_2_icone'    => $this->img( 'chatgpt-caso-2' ),
			'solucao_casos_2_titulo'   => 'Automatize atendimento',
			'solucao_casos_2_desc'     => 'Combine dados de CRM, pedidos e suporte para gerar respostas contextualizadas e acelerar a resolução de solicitações.',
			'solucao_casos_3_icone'    => $this->img( 'chatgpt-caso-3' ),
			'solucao_casos_3_titulo'   => 'Analise documentos automaticamente',
			'solucao_casos_3_desc'     => 'Extraia informações de contratos, notas, propostas e outros documentos para alimentar processos corporativos.',
			'solucao_casos_4_icone'    => $this->img( 'chatgpt-caso-4' ),
			'solucao_casos_4_titulo'   => 'Classifique e encaminhe solicitações',
			'solucao_casos_4_desc'     => 'Interprete mensagens recebidas e direcione cada solicitação para a equipe ou processo adequado.',
			'solucao_casos_5_icone'    => $this->img( 'chatgpt-caso-5' ),
			'solucao_casos_5_titulo'   => 'Crie agentes conectados',
			'solucao_casos_5_desc'     => 'Orquestre modelos de IA com ferramentas e sistemas corporativos para executar tarefas além de apenas gerar respostas.',
			'solucao_casos_cta_texto'  => 'Agende uma demonstração',
			'solucao_casos_cta_url'    => '/contato/',
